...
class AppColors {
  static const Color ink = Color(0xFF14171C);       // ডার্ক ব্ল্যাক
  static const Color cream = Color(0xFFFFFBF3);     // লাইট ব্যাকগ্রাউন্ড
  static const Color coral = Color(0xFFFF5A36);     // প্রাইমারি অরেঞ্জ
